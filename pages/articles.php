    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8 col-md-12 icon-box border-box">
          <h3 class="title-principal-detail text-center">
            <?php echo $titre_article; ?>
          </h3><br>
          ...
          if ($contenu == NULL && !isset($_GET['id']) && empty($_GET['id'])) { ?>
            ...
            <div class="holderCircle">
              ...
              <div class="dotCircle text-center">
                ...
                foreach ($axes as $axe):
                  ...
                  ?>
                  <span class="itemDot itemDot<?php echo $axe->id; ?> <?php if ($axe->id == 1)
                       echo 'active'; ?>"
                    data-tab="<?php echo $axe->id; ?>"
                    onclick="window.location='index.php?page=add-content&id=<?php echo $axe->id; ?>'">
                    <span class="forActive" style="white-space: nowrap ; text-align: right !important;">
                      <br>
                      <div class="bg-white text-center"
                        style="<?php echo $style; ?> margin: 0px -40px 0px !important; border: 1px solid #363636;">
                        <h2 class="title-secondaire-detail" style="font-size: 16px !important">
                          <bi class="bi-caret-left-fill"></bi>
                          <?php echo nl2br($axe->name_ar); ?>
                        </h2>
                      </div>
                    </span>
              ...
              <div class="contentCircle">
                <?php
                foreach ($axes as $axe): ?>
                  <div class="CirItem title-box <?php if ($axe->id == 1)
                    echo 'active'; ?> CirItem<?php echo $axe->id; ?>"
                    onclick="window.location='index.php?page=add-content&id=<?php echo $axe->id; ?>'">
            ...
            <div class="hidden-lg hidden-md hidden-sm" style="margin-bottom: 440px !important;"></div>
            <?php
