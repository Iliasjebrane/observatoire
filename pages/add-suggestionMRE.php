          ...
          <div class="container">
            ...
            <?php 
              ...
              if(isset($_POST['btn_ajouter']) ){
                ...
                $requete = Config::selectData("SELECT MAX(id) as max_id FROM `suggestionMRE`", NULL);
                ...
                if ($erreurExtension==false) {
                  ...
                  $query = "INSERT INTO `suggestionMRE`(`proposeur`, `intitule`, `nom_ar`, `prenom_ar`, `telephone`, `email`, `description`, `piece_jointe`) 
                  ...
                  if($last_id > 0){ ?>
                    ...
                    <div class="alert alert-success rounded-0" role="alert">
                      ...
                      <button type="button" class="close hidden" data-dismiss="alert" aria-label="Close" onclick="window.location='index.php?page=add-suggestionMRE'">
                ...
                echo '<META http-equiv="refresh" content="5; URL=index.php?page=add-suggestionMRE">';
                  ...
                  <div class="card-header py-3 text-center">
                    <h2 class="fs-6 fw-bold m-0 title-secondaire-detail">
                      <i class="bi bi-stack hidden"></i>
                       نافذة خاصة بأفراد الجالية بالخارج سواء من أبناء مدينة القنيطرة أو الذين تربطهم بها  أي صلات أخرى.    <br>
                    </h2>
                  </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-10">
                            ...
                            <div class="col-md-12 mt-4">
                              <div class="form-group row">
                                <label for="telephone" class="col-md-3 col-form-label">  بلد الإقامة    :</label>
                                <div class="col-md-8"> 
