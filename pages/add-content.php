<?php 
  ...
  if(!isset($_GET['id']) && empty($_GET['id'])){
    ...
    $id_axe = htmlentities(trim($_GET['id']));

    $axes = Axes::getAxe($id_axe); 
    $name_axe_ar=NULL;
    ...
    $sous_axes = Axes::getSousAxes($id_axe);

    if(!empty($axes)){
      $name_axe_ar=$axes->name_ar; 
      $description_title = $axes->description_ar;
      $icon=$axes->ico;
    } ?>
    ...
    <main id="main"  style="margin: 0px !important; padding: 0px !important;">
        ...
        <section class="breadcrumbs"  id="add_article" style="margin-top: 80px !important;  ">
          <div class="container"  >
            ...
            <div class="d-flex justify-content-between align-items-center" dir="rtl" id="link-axe">
               
              <ol>
                <li><a href="index.php">الرئيسية </a></li>
                <li>&nbsp; &nbsp; <?php echo $name_axe_ar;?></li> 
              </ol>
                  ...
                  <div class="card-header py-3">
                    <h2 class="fs-6 fw-bold m-0 title-secondaire-detail">
                      <i class="bi bi-pencil"></i>
                       <?php echo $name_axe_ar.': '.$description_title;?>
                    </h2>
                  </div>
                  <form role="form" action="" method="POST" id="addProSol_form">
                      ...
                      <div class="row"> 
                        ...
                        <div class="col-md-12">
                          <div class="form-group row">
                            <input type="text" class="hidden" name="axe" id="axe" value="<?php echo $id_axe;?>">
                            <label for="sous_axe" class="col-md-3 col-form-label">الموضوع  <code>(*) </code>:</label>
                            <div class="col-md-9">
                              <select class="form-select" name="sous_axe" id="sous_axe"  onchange="document.getElementById('probleme_ar').focus();" required autofocus >
                                <option value=""> --- اختر الموضوع  --- </option>
                                <?php  
                                  foreach($sous_axes as $sous_axe):?>
                                    <option value="<?php echo $sous_axe->id; ?>">
                                      <?php echo $sous_axe->objet_ar;?>
                                      </option><?php 
                                  endforeach; 
                                ?>          
                              </select> 
                        ...
                        <div class="col-md-12 mt-4">
                          <div class="form-group row">
                            <label for="probleme_ar" class="col-md-3 col-form-label">    الصعوبات والمشاكل   <code>(*) </code>:</label>
                            <div class="col-md-9"> 
                              <textarea class="form-control form-control-sm rounded-0" rows="6" name="probleme_ar" id="probleme_ar" required></textarea>
                              <div class="invalid-feedback"> <code>   المرجو ملء  الخانة    </code> </div>
                            </div>
                          </div>
                        </div><!-- col-md-12 --> 
                        ...
                        <div class="col-md-12 mt-4">
                          <div class="form-group row">
                            <label for="solution_ar" class="col-md-3 col-form-label">   الحلول،  الحاجيات  والمقترحات   <code>(*) </code>:</label>
                            <div class="col-md-9"> 
                              <textarea class="form-control form-control-sm rounded-0" rows="6" name="solution_ar" id="solution_ar" required> </textarea>
                              <div class="invalid-feedback"> <code>   المرجو ملء  الخانة    </code> </div>
                            </div>
                          </div>
                        </div><!-- col-md-12 -->
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-success btn-sm me-1 mb-2" name="btn_ajouter" id="btn_ajouter" form="addProSol_form">
                        حفظ المعلومات
                      ...
                      <button type="button" class="btn btn-dark btn-sm me-1 mb-2" onclick="window.location='index.php?page=articles';">
                        رجوع
