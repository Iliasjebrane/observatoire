                  ...
                  <table  class="table table-striped table-bordered" id="example" style="text-align: right;" > 
                    ...
                    <thead> 
                        <tr class="" style="background-color: #273B7A; font-size: 14px;"> 
                            ...
                            <th style="color: #fff; text-align: center; width: 20%;">
                                اسم المحور
                            </th>
                            <th style="color: #fff; text-align: center; width: 25%;">
                                الموضوع
                            </th>
                            <th style="color: #fff; text-align: center; width: 25%;">
                                المشاكل
                    ...
                    <tbody> <?php 
                      ...
                      foreach($ProSols as $ligne){?>  
                      
                        <tr align="right" style="font-size: 13px;">
                                           
                          <td class="" align="center"><?php echo $ligne->id; ?></td> 
                          <td ><?php echo $ligne->name_axe; ?></td>  
                          <td ><?php echo $ligne->objet_ar; ?></td>  
                          <td ><?php echo $ligne->probleme_ar; ?></td> 
                          <td ><?php echo $ligne->solution_ar; ?></td> 
