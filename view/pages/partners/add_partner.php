...
<div id="form-container"
    ...
    <form action="<?= route('admin/partners') ?>" enctype="multipart/form-data" method="post"
        ...
        <div class="row p-error ">
            ...
            <div class="col-md-7 d-flex flex-column">
                <input type="text" required name="adresse" value="<?= old("adresse") ?>" id="adresse"
                    class="form-control ">
        ...
        <div class="row p-error ">
            ...
            <div class="col-md-7 d-flex flex-column">
                <input type="text" required name="tele" value="<?= old("tele") ?>" id="tele" class="form-control ">
                <?php if (error('tele')): ?>
                    <div class="text error">
                        <?= error("tele") ?>
                    </div>
