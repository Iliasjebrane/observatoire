...
<div id="form-container"
        ...
        <div class=" d-flex justify-content-center w-100">
                <span class=" mt-3 mb-0">modifier utilisateur</span>
        </div>
        <hr>

        <form action="<?= route('admin/users/' . $user["id"]) ?>" method="post" class="d-flex flex-column gap-3  p-1">
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="nom_fr" required name="nom_fr"
                                        value="<?= $user['nom_fr'] ?? old("nom_fr") ?>" id="nom_fr"
                                        class="form-control ">
                                <?php if (error('nom_fr')): ?>
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="nom_ar" required name="nom_ar" value="<?= $user['nom_ar'] ?? old("nom_ar") ?>"
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="prenom_fr" required name="prenom_fr"
                                        value="<?= $user['prenom_fr'] ?? old("prenom_fr") ?>" id="prenom_fr"
                                        class="form-control ">
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="prenom_ar" required name="prenom_ar"
                                        value="<?= $user['prenom_ar'] ?? old("prenom_ar") ?>" id="prenom_ar"
                                        class="form-control ">
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="username" required name="username"
                                        value="<?= $user['username'] ?? old("username") ?>" id="username"
                                        class="form-control ">
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="tele" required name="tele" value="<?= $user['tele'] ?? old("tele") ?>"
                                        id="tele" class="form-control ">
                                <?php if (error('tele')): ?>
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="email" required name="email" value="<?= $user['email'] ?? old("email") ?>"
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <select name="role" class="form-control" required>
                                        ...
                                        <?php foreach ($roles as $role): ?>
                                                <option value="<?= $role['id'] ?>" <?= ($role['id'] == $user['role_id'] ?? old('role')) ? 'selected' : "" ?>><?= $role['name_fr'] ?></option>
                                        <?php endforeach; ?>
                                </select>
                                <?php if (error('role')): ?>
