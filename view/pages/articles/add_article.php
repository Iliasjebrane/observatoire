...
<div id="form-container"
        ...
        <div class=" d-flex justify-content-center w-100">
                <span class=" mt-3 mb-0">ajouter articles</span>
        </div>
        <hr>

        <form enctype="multipart/form-data" action="<?= route('admin/articles') ?>" method="post"
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <textarea name="description_fr" rows="5"
                                        class="form-control"><?= old("description_fr") ?> </textarea>
                                <?php if (error('description_fr')): ?>
                                        <div class="text error">
                ...
                <div class="row p-error ">
                        ...
                        <div class="col-md-7 d-flex flex-column">
                                <input type="file" required name="image"
                                        value="<?= $article['image'] ?? old("image") ?>" id="image"
                                        class="form-control ">
                                <?php if (error('image')): ?>
